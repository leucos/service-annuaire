...
class UserApi < Grape::API
  ...
  resource :users do
    ...
    get do
      ...
      accepted_fields = {
        prenom: :prenom, nom: :user__nom, login: :login, code_uai: :etablissement__code_uai, etablissement: :etablissement__nom, id: :user__id, id_ent: :id_ent, profil_id: :profil_user__profil_id, profil: :profil_national__description
      }
