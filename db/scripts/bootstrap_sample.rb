...
def create_super_admin_and_ressource_laclasse()
  ...
  u = User.create(:nom => "NOM", :prenom => "Penom", :sexe => "M", :login => "login", :password => "*********")
...
=end 
  ...
  # create super admin users   : role = TECH 
  u = User.create(:nom => "user1", :prenom => "user1", :sexe => "M", :login => "some logins", :password => "passwords")
