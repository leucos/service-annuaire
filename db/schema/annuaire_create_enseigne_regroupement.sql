...
-- -----------------------------------------------------
-- Table `annuairev2`.`application_key`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `annuairev2`.`application_key` ;

CREATE  TABLE IF NOT EXISTS `annuairev2`.`application_key` (
  `application_id` CHAR(8) NOT NULL ,
...
CREATE INDEX `fk_application_key_application1` ON `annuairev2`.`application_key` (`application_id` ASC) ;
