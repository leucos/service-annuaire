...
CREATE  TABLE IF NOT EXISTS `annuaire`.`activite_role` (
  ...
  PRIMARY KEY (`activite_id`, `role_id`, `service_id`, `ressource_service_id`, `ressource_id`) ,
  ...
  INDEX `fk_activite_role_ressource1` (`ressource_service_id` ASC, `ressource_id` ASC) ,
  ...
  CONSTRAINT `fk_activite_role_service1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_activite_role_ressource1`
