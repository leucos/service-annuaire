...
## Les APIs Etablissement:
  ...
  14. POST /api/etablissements/{id}/user/{user_id}/role_user Assigner un role à un utilisateur
  15. PUT /api/etablissements/{id}/user/{user_id}/role_user/{old_role_id} Changer le role de quelqu'un
  16. DELETE /api/etablissements/{id}/user/{user_id}/role_user/{role_id} Supprimer un role de l'utilisateur dan   s l'etablissement
  ----------------------
  ...
  24. POST /api/etablissements/{id}/classes/{classe_id}/role_user/{user_id} Gestion des rattachements et des ro   les
  25. PUT /api/etablissements/{id}/classe/{classe_id}/role_user/{user_id}/{old_role_id} modifier le role d'un u   tilisateur dans une classe
  26. DELETE /api/etablissements/{id}/classe/{classe_id}/role_user/{user_id}/{role_id} Dettachement
  27. GET /api/etablissements/{id}/classes/{classe_id}/profs Lister les enseignants dans une classe
    28. POST /api/etablissements/{id}/classes/{classe_id}/profs/{user_id} Ajouter un enseignant et ajouter des ma   tieres
    29. DELETE /api/etablissements/{id}/classes/{classe_id}/profs/{user_id} supprimer un enseignant
  30. DELETE /api/etablissements/{id}/classe/{classe_id}/profs/{user_id}/matieres/{matiere_id} supprimer une matieres
  ------------------------
